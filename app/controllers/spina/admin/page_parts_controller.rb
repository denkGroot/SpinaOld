module Spina
  class Admin::PagePartsController < Admin::ApplicationController
    ...
    def create
      if @page_part.save
        redirect_to admin_page_parts_url, notice: "Nieuwe paginasectie is aangemaakt."
      else
    ...
    def update
      if @page_part.update_attributes(params[:page_part])
        redirect_to admin_page_parts_url
      end
    end

    def destroy
      @page_part.destroy
      redirect_to admin_page_parts_url, notice: "De paginasectie is verwijderd."
    end
